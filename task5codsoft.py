...
Original file is located at
    https://colab.research.google.com/drive/1Aym_cGF4lKZp_2gYcWgE4PawfVThkJhH
"""
...
##Aim : To detect credit card fraud.
...
X_res, y_res = SMOTE(k_neighbors=1).fit_resample(X_cleaned, y_cleaned)
